...
// TODO: Rewrite. Maybe with https://github.com/Polymer/pwa-helpers
...
export class PolymerHelmet extends PolymerElement {
  ...
  @observe('title', 'description', 'image', 'label1', 'data1', 'label2', 'data2')
  _setMetaInfo(title, description, image, label1, data1, label2, data2) {
