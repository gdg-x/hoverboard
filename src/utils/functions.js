...
export const getVariableColor = (element, value, fallback) => {
...
export const parseQueryParamsFilters = (queryParams) => {
  return queryParams
    .split('&')
...
export const toggleQueryParam = (currentQueryParams, key, value) => {
