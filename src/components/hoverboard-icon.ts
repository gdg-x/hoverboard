...
const ICONS: Record<string, SVGTemplateResult> = {
  ...
  directions: svg`<path d="M21.71 11.29l-9-9a1 1 0 0 0-1.42 0l-9 9a1 1 0 0 0 0 1.41l9 9a1 1 0 0 0 1.42 0l9-9a1 1 0 0 0 0-1.41zM14 14.5V13h-4v3H8v-5a1 1 0 0 1 1-1h5V8.5l3.5 3.5-3.5 3.5z"></path>`,
