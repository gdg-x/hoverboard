...
The first round of general admission tickets will become available on January 9th 12pm EST. There is a limited number of tickets, so buy them as soon as you can! Our early bird tickets sold out in 48 hours. The price will increase for round two of general admission sales. Tickets are not for resale. IDs will be checked at the door. In line with RadicalxChange's values, these tickets are being sold to real unique humans (that's you!) not as commodities, so we want to make sure it is the inspired community members who will contribute to the event that are showing up with the tickets they purchased.
...
*Day 1: Inspire + Connect*
  
**SATURDAY, MARCH 23, 2019**

*Day 2: Learn + Experience*
  
**SUNDAY, MARCH 24, 2019**

*Day 3: Catalyze Action*
