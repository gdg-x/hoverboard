...
const ADD_POTENTIAL_PARTNER_FAILURE =
  'app/Partners/ADD_POTENTIAL_PARTNER_FAILURE';
const ADD_POTENTIAL_PARTNER_SUCCESS =
  'app/Partners/ADD_POTENTIAL_PARTNER_SUCCESS';
...
const FETCH_PREVIOUS_SPEAKERS_FAILURE =
  'app/PreviousSpeakers/FETCH_SPEAKERS_FAILURE';
const FETCH_PREVIOUS_SPEAKERS_SUCCESS =
  'app/PreviousSpeakers/FETCH_SPEAKERS_SUCCESS';
...
const FETCH_USER_FEATURED_SESSIONS =
  'app/Sessions/FETCH_USER_FEATURED_SESSIONS';
const FETCH_USER_FEATURED_SESSIONS_FAILURE =
  'app/Sessions/FETCH_USER_FEATURED_SESSIONS_FAILURE';
const FETCH_USER_FEATURED_SESSIONS_SUCCESS =
...
const SET_USER_FEATURED_SESSIONS_FAILURE =
  'app/Sessions/SET_USER_FEATURED_SESSIONS_FAILURE';
const SET_USER_FEATURED_SESSIONS_SUCCESS =
  'app/Sessions/SET_USER_FEATURED_SESSIONS_SUCCESS';
// schedule
...
// job offers
const FETCH_JOB_OFFERS = 'app/JobOffers/FETCH_JOB_OFFERS';
const FETCH_JOB_OFFERS_FAILURE = 'app/JobOffers/FETCH_JOB_OFFERS_FAILURE';
const FETCH_JOB_OFFERS_SUCCESS = 'app/JobOffers/FETCH_JOB_OFFERS_SUCCESS';
...
const UPDATE_NOTIFICATIONS_STATUS =
  'app/Notifications/UPDATE_NOTIFICATIONS_STATUS';
